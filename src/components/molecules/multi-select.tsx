...
>(
  (
    ...
    const internalValue = value ?? selectedValues;
    ...
    const toggleOption = (option: string) => {
      const newSelectedValues = internalValue.includes(option)
    ...
    return (
      ...
      >
            ...
            {internalValue.length > 0 ? (
              <div className="flex justify-between items-center w-full">
                <div className="flex flex-wrap items-center">
                  {internalValue.slice(0, maxCount).map((value) => {
                  ...
                  {internalValue.length > maxCount && (
                    <Badge
                      ...
                      style={{ animationDuration: `${animation}s` }}
                    >
                      {`+ ${internalValue.length - maxCount} more`}
                    </Badge>
                  )}
                </div>
        ...
        {animation > 0 && internalValue.length > 0 && (
          <WandSparkles
            className={cn(
